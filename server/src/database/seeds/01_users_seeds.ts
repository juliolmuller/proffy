...
export async function seed(knex: Knex): Promise<void> {
  ...
  const bio =
    'Lorem ipsum dolor sit amet consectetur adipisicing elit.Beatae consequatur, deserunt quibusdam nesciunt nobis voluptatum. Dicta error, vero, itaque numquam voluptates laudantium quod quasi commodi ea omnis officiis illum eos!';
  const users: Partial<UserRecord>[] = [
    ...
    {
      name: 'Aurelio S. Matsunaga',
      avatar: 'https://github.com/aureliomatsunaga.png',
      whatsapp,
      bio,
    },
