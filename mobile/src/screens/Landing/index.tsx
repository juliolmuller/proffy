  ...
  return (
    <View style={styles.screenWrapper}>
      ...
      <Text style={styles.greetings}>
        Seja bem vind@! {'\n'}
        <Text style={styles.greetingsPrompt}>o que deseja fazer?</Text>
      </Text>
      ...
      <Text style={styles.totalConnections}>
        Total de {connectionsCount} conexões já realizadas <Image source={heartIcon} />
      </Text>
    </View>
  );
}
